...
L95A0:  .word EnemyFramePtrTbl1         ;Pointer table into enemy animation data. Two-->
...
L9AEA:  ASL 
L9AEB:  TAY 
L9AEC:  LDA CommonRoutines+1,Y
L9AEF:  PHA 
L9AF0:  LDA CommonRoutines,Y
L9AF3:  PHA 
L9AF4:  RTS
...
L9B62:  STA $6AFE,X
L9B65:  LDA EnData05,X
L9B68:  AND #$01
L9B6A:  TAY 
L9B6B:  LDA $9BA0,Y
L9B6E:  STA $0403,X
L9B71:  LDA EnData05,X
L9B74:  ASL 
L9B75:  BMI $9B95
...
.advance $B000, $00
.include "../music/BrinstarMusic.asm"
